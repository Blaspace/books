  ...
  return (
    <div className="terms-con">
      <div className="terms">
        ...
        <ul>
          <li>
            "User", "You", and "Your" refers to you, the person log on this
            website and compliant with the Company’s terms and conditions.
          </li>
          <li>
        ...
        <h2>Privacy</h2>
        <p>
          We do not collect personal data from users. However, we use Google Ads
          on our website, which may use cookies to serve ads based on a user's
